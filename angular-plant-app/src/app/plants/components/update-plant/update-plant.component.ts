...
export class UpdatePlantComponent {
  ...
  constructor(private _fb: FormBuilder, private _jobsService: PlantsService, private _route: ActivatedRoute, private _router: Router) {}
