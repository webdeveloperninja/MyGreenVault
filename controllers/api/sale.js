...
function createSaleReport(sale) {
  ...
  <table cellpadding="0" cellspacing="0" style="width: 100%;line-height: inherit;text-align: left;">
        ...
        <table style="width: 100%;line-height: inherit;text-align: left;">
          <tr>
            <td class="title" style="padding: 5px;vertical-align: top;padding-bottom: 20px;font-size: 45px;line-height: 45px;color: #333;">
              <img src="http://mygreenvault.com/wp-content/uploads/2018/02/icon.png" style="width:100%; max-width:125px;">
            </td>

            <td style="padding: 5px;vertical-align: top;text-align: right;padding-bottom: 20px; font-weight: bold;">
              Transaction#: ${sale._id}
              <br>
            </td>
          </tr>
        </table>
        ...
        <table style="width: 100%;line-height: inherit;text-align: left;">
          <tr>
            <td style="padding: 5px;vertical-align: top;padding-bottom: 40px;">
              ${sale.businessName}
              <br> ${sale.businessAddress}
              <br> ${sale.businessState}, ${sale.businessCity} ${sale.businessZip}
            </td>

            <td style="padding: 5px;vertical-align: top;text-align: right;padding-bottom: 40px;">
              ${sale.contactName}
              <br> ${sale.contactEmail}
            </td>
          </tr>
        </table>
      </td>
    ...
    <tr class="total">
      ...
      <td style="padding: 5px;vertical-align: top;text-align: left;border-top: 2px solid #eee;font-weight: bold;">
